			...
			function() {
				$('#courseDropdown').on(
						...
						function() {
							...
							cell0.innerHTML = val[0];
							var cell1 = row.insertCell(1);
							cell1.innerHTML = val[1];
							var cell2 = row.insertCell(2);
							cell2.innerHTML = '<a href="javascript:void(0)" title="Delete Course"><i class="fa fa-trash"></i></a>';
								...
								<table id="gradeAssociateCourseTable" data-toggle="table">
									<thead class="table-primary">
										<tr>
											...
											<th scope="col">eLearning Subject</th>
