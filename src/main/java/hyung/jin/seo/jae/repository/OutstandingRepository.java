...
public interface OutstandingRepository extends JpaRepository<Outstanding, Long>{  
	...
	@Query(value = "SELECT new hyung.jin.seo.jae.dto.OutstandingDTO(o.id, o.paid, o.remaining, o.total, o.registerDate, o.invoice.id) FROM Outstanding o WHERE o.invoice.id = ?1")
